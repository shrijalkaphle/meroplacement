        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 py-3 card card-body">
                    <form action="{{ route('user.jobseeker.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div id="basic">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" name="dob" required class="form-control"  value="{{ old('dob') }}">
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="nationality" required class="form-control"  value="{{ old('nationality') }}">
                                </div>
                                <div class="col-md-4">
                                    <label for="current_address">Current Address <span style="color:red">*</span></label>
                                    <input type="text" name="current_address" required class="form-control"  value="{{ old('current_address') }}">
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <input type="file" name="photo" onchange="LoadImage(event)" required class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <img src="" id="preview" style="max-height:150px">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="aboutme">About Me <span style="color:red">*</span></label>
                                <textarea name="aboutme" id="aboutme" cols="30" rows="10">{{ old('aboutme') }}</textarea>
                            </div>
                            <hr>
                            ...
                            <div class="row form-group">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="specialization" required class="form-control"  value="{{ old('specialization') }}">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="current_company" required class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label for="current_position">Current Position <span style="color:red">*</span></label>
                                    <input type="text" name="current_position" required class="form-control">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-md-6">
                                    <label for="current_salary">Current Salary(NPR.)</label>
                                    <input type="text" name="current_salary" class="form-control"  value="{{ old('current_salary') }}">
                                </div>
                                <div class="col-md-6">
                                    <label for="expected_salary">Expected Salary(NPR.) <span style="color:red">*</span></label>
                                    <input type="text" name="expected_salary" required class="form-control"  value="{{ old('expected_salary') }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <center>
